...
- [ ] Bundle worker/WASM startup for browser and server runtimes and test Chromium, Firefox, Safari, Node, Deno, and
  Bun rather than relying on browser-global `Worker`/`fetch` behavior.
