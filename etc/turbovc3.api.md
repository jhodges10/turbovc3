...
export interface DecodeColorSpace {
    // (undocumented)
    fullRange: boolean;
    // Warning: (ae-forgotten-export) The symbol "DecodeColorMatrix" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    matrix: DecodeColorMatrix;
    // Warning: (ae-forgotten-export) The symbol "DecodeColorPrimaries" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    primaries: DecodeColorPrimaries;
    // Warning: (ae-forgotten-export) The symbol "DecodeColorTransfer" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
